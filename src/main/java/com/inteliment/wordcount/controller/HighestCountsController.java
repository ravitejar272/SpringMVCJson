...
import main.java.com.inteliment.wordcount.model.WordCount;
	...
	@RequestMapping(value = "{howMany}", method = RequestMethod.GET )
 	public @ResponseBody String getTop(@PathVariable String howMany) {
			...
			try {
				...
				count = 1;					//defaulting to topmost 1 item in the event of wrong input such as alphanumeric instead of numeric resulting in NumberFormatException; This is mentioned in the assumptions
			}
	 		String wordCount = WordCount.getInstance(count);
